...
import { Search, X, Palmtree, Plane, Building2, AlertTriangle, RotateCcw } from 'lucide-react';
...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="bg-[#0e111a] border-b border-slate-800/80 p-3 lg:px-6 space-y-3 z-10 shrink-0">
      {/* Top row: Search input + Quick Action Toggles */}
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <div className="relative flex-1 min-w-[240px] max-w-md">
          ...
          <input
            type="text"
            placeholder="Search by name, organization, title, keywords..."
